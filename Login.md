...
<script>
    ...
    function login_api(uid, pw){
      ...
      fetch("http://localhost:8082/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='https://PatrickHastings2.github.io/STUDENTREPO2//2023/01/22/Signup_page_demographics.html'" class="button-spacing" >Sign Up</button>
    </p>
  </form>